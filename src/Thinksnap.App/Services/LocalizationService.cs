...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Update.Verifying"] = "Verifying downloaded update...",
            ["Update.Heading"] = "Updating Thinksnap",
            ["Update.CompletedHeading"] = "Update completed",
            ["Update.CompletedStatus"] = "Thinksnap {0} was installed successfully.",
            ["Update.CompletedProgress"] = "100%  Complete",
        ...
        ["tr"] = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Update.Verifying"] = "İndirilen güncelleme doğrulanıyor...",
            ["Update.Heading"] = "Thinksnap güncelleniyor",
            ["Update.CompletedHeading"] = "Güncelleme tamamlandı",
            ["Update.CompletedStatus"] = "Thinksnap {0} başarıyla kuruldu.",
            ["Update.CompletedProgress"] = "%100  Tamamlandı",
